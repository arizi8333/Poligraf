...
<body>
    <div class="row">
        <div class="text-center">
            ...
            <div style="font-size:16px"><b><u>QUOTATION</u></b></div>
        </div>
        <div style="margin-left:60px;margin-right:60px;margin-top:20px;">
            <div style="font-size:13px;">
                <span>Ref. No : {{$data[0]->pemesanan_id}}</span>
            ...
            <table style="width:100%;font-size:13px;">
                ...
                <tr>
                    <td style="width:20%">Telp/Mobile </td>
                    <td>: {{$data[0]->pemesanan->user->telp_perusahaan}} / {{$data[0]->pemesanan->user->no_hp}}</td>
                </tr>
                <tr>
            ...
            <table style="margin-top:40px;width:100%;font-size:13px;border: 1px solid;">
                    ...
                    @endforeach
                    <tr style="border: 1px solid;">
                        <th height="35px" style="padding-right:10px;border: 1px solid;text-align: center" colspan="3">Total</th>
            ...
            <div style="margin-top:30px;font-size:13px">
                <span><b>Kondisi Penawaran : </b></span>
                <div> - Harga : Franco Jakarta, Non-PPn</div>
                <div> - Pembayaran : 100% Lunas Diawal</div><br>
                ...
                <div><u><b>Agung Prasetye</b></u></div>
                <div>Direktur</div>
            </div>
        </div>
    </div>
