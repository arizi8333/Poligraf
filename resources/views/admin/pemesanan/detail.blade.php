...
<nav aria-label="breadcrumb">
    <ol class="breadcrumb breadcrumb-style1">
        ...
        <li class="breadcrumb-item">
        <a href="{{url('admin/pemesanan/index')}}">Pemesanan</a>
        </li>
                        ...
                        <div class="col-3">
                            ...
                            <div class="m-2">
                                @if($pemesanan[0]->pemesanan->bukti_pembayaran == null || $pemesanan[0]->pemesanan->bukti_pembayaran == " ")
                                    <button onclick="alert()" class="btn btn-sm btn-secondary">Bukti</button>
                                @else
                                    <button id="bukti" class="btn btn-sm btn-primary">Bukti</button>
                                @endif
                                <button id="edit" class="btn btn-sm btn-primary">Edit</button>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="modal fade" id="modal" tabindex="-1" aria-hidden="true">
            ...
            <div class="modal-content">
                ...
                <div class="row">
                        ...
                        <label for="nameBasic" class="form-label">Jam Pembayaran</label>
                        <input type="time" name="jam_pembayaran" class="form-control">
                ...
                <div class="row">
                    <div class="col mb-3">
                    <label for="nameBasic" class="form-label">Action</label>
...
<script>
    ...
    $(document).on('click', '#edit', function() {
        ...
        $('#form').attr('action', '{{ url('admin/pemesanan/update') }}/'+data_replace);  
    });
    ...
    $( "#admin-menu-pemesanan" ).addClass( "active" );
