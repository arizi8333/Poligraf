...
<script>
                    ...
                    { 
                        ...
                        render: function (data) {
                            if(data == 0){
                                ...
                                return "<span class='badge bg-secondary'>Need Action</span>";
                            }else if(data == 2){
    ...
    $(document).on('click', '#add', function() {
        $("a").attr("href", "{{url('admin/pemesanan/create')}}")    
    });

    $(document).on('click', '#edit', function() {
        $('#modal').modal('show');
        var id = $(this).data('id');
        $("a").attr("href", "{{url('admin/pemesanan/edit')}}/"+id)  
    });
